...
// advance tokens
// loop until token is EOF
// For each token, parse token as statement
// push statement to program graph
// a let statement must have an identifier, equal sign, and expression in correct order
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	//TODO: expression parser until semicolon
